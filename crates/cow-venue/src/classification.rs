...
use nexum_sdk::chassis::RetryAction;
...
/// field. Turned into a chassis [`RetryAction`] by [`GeneratedRow`].
...
/// Classify an orderbook `errorType` into a chassis [`RetryAction`] via
