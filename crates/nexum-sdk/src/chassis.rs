//! Strategy-chassis stores: the persistent-state conventions shared by
...
//!
//! ```
//! use nexum_sdk::chassis::{Gates, Journal, WatchRef, WatchSet};
...
/// Prefix of the submitted-receipt journal markers.
pub const SUBMITTED_PREFIX: &str = "submitted:";
/// Prefix of the observed-receipt journal markers.
...
impl<'k> WatchRef<'k> {
    ...
    /// the separating colon is missing.
