...
//!   [`decode_revert`]), the classifiers mapping submit failures into
//!   the chassis [`RetryAction`], and [`materialise`] - the poll ->
//!   outcome -> gate/journal/submit composition over the chassis
//!   stores.
//!
