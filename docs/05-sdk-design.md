...
└── src/
    ...
    ├── chassis.rs             # WatchSet, Gates, Journal, ConditionalSource, RetryLedger
...
└── src/
    ...
    │                           # RetryAction classifiers, materialise() (poll -> gate/journal/submit)
    └── proptests.rs           # cfg(test) property tests (not part of the public surface)
```
...
`ConditionalSource`, `RetryLedger` - give conditional-commitment
